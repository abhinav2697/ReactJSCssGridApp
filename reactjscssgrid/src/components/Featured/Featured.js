  ...
  return (
    <div className='featured'>
      ...
      <div className='container'>
        <img className='span-3 image-gird-row-2' src={House1} alt='' />
        <img src={Bed1} alt='' />
        <img src={Bed2} alt='' />
        <img src={kitchen} alt='' />
        ...
        <div className='span-2 right-img-details order-7'>
                    <p>A beautiful modern day home in the city with a full-size pool. Spacious and luxurious home located in Hyderabad. Including media room, workout facility, and built-in sauna. </p>
